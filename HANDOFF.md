...
| Total auction-history records | **1,353**, verified via `history-refresh.yml` run `31198972181` (2026-08-07, push-triggered pre-merge check, not yet committed to `main` — run the workflow via `schedule`/`workflow_dispatch` to commit) |
